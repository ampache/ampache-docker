...
RUN apt-get -q -q -y install inotify-tools mysql-server apache2 php php-json php-curl php-mysql pwgen lame libvorbis-dev vorbis-tools flac libmp3lame-dev libavcodec-extra libfaac-dev libtheora-dev libvpx-dev ffmpeg git cron
