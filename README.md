...
- **GitHub Workflow**: The addition of a GitHub workflow facilitates Continuous Image Build for each commit or pull reauest (To do: Add push only on master commit).
